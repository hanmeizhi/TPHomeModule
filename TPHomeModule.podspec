...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/hanmeizhi/TPHomeModule'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'qdn' => 'hanmeizhi@163.com' }
  s.source           = { :git => 'https://github.com/hanmeizhi/TPHomeModule.git', :tag => s.version.to_s }
